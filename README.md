...
The MCP that helped me the most was **GitHub** — it created a public repository and pushed all my files with one instruction, which I would not have known how to do on my own. **Fetch** was also very useful because it pulled real facts about Apple, Microsoft, Google and the other companies straight from the web, so the "Did you know?" section shows genuine information that rotates every 30 seconds. The thing that surprised me most was how easy it was to keep adding features just by describing what I wanted in plain English — I ended up going well beyond the basic requirements with a Beat the Market indicator, a Risk vs. Return scatter chart, and a custom design inspired by another app. I took the screenshots manually rather than using Playwright because it gave me more control — I could choose exactly which section of the app to capture and split them neatly by feature for my report.
